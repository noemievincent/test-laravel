<header class="px-6 py-4 bg-white shadow">
    <div class="container flex flex-col mx-auto md:flex-row md:items-center md:justify-between">
        ...
        <form action="/search" method="get" class="flex items-center gap-2">
            <input type="search" name="query" class="border border-dark rounded py-2">
            <input type="submit" value="search" class="w-1/3 py-2 px-4 rounded bg-blue-700 text-white shadow">
        </form>
